  ...
  return (
    <div>
      <section className="w-[100%] min-h-[50vh] xl:min-h-[100vh] relative">
        ...
        <Link to={"/habitaciones"} className="p-3 vsm:text-[.9rem] mb:text-[1rem] vsm:w-[90%] mb:w-[75%] text-[14px] rounded-[5px] md:rounded-none md:p-4 md:w-[100%] flex gap-3 justify-center items-center md:text-[1rem] bg-amber-400  md:mt-8 text-[#0e2541] md:max-w-[270px] lg:hover:bg-gray-950 lg:hover:text-[#fff] xl:p-5">
