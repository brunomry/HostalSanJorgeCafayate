  ...
  return (
    <div>
      <section className="w-[100%] min-h-[50vh] xl:min-h-[100vh] relative">
        ...
        <div className=".bannerHome__description absolute top-[200px] left-5 right-5 mb:top-[150px] xl:top-[100px] xl:left-[100px] 2xl:left-[25%] 2xl:top-[25%] flex flex-col gap-2 md:gap-3  bg-[rgba(43,69,94,0.8)] px-3 py-5 md:p-10 xl:p-20 md:max-w-[550px] lg:max-w-[650px] xl:max-w-[750px] xl:mt-[75px] 2xl:mt-[0] min-h-[100px] rounded-[10px] md:rounded-none">
        ...
        <Link to={"/habitaciones"} className="p-3 vsm:w-[90%] mb:w-[75%] text-[14px] rounded-[5px] md:rounded-none md:p-4 md:w-[100%] flex gap-3 justify-center items-center md:text-[1rem] bg-amber-400  md:mt-8 text-[#0e2541] md:max-w-[270px] lg:hover:bg-gray-950 lg:hover:text-[#fff] xl:p-5">
