  ...
  return (
    <div>
      <section className="bannerHome">
        ...
        <Link to={"/habitaciones"} class="p-2 md:p-4 w-[100%] flex gap-3 justify-center items-center text-[1rem] bg-amber-400  md:mt-8 text-[#0e2541] md:max-w-[270px] lg:hover:bg-gray-950 lg:hover:text-[#fff] ">
