...
const Comentarios = () => {
  return (
    <section className="md:absolute w-[100%] vsm:mt-[200px] mb:mt-0 md:top-[55%] lg:relative lg:top-[450px] pb-10 mb:mb-[0px] lg:pb-20 xl:absolute xl:top-[90%] lg:mx-auto min-h-[400px] flex flex-col items-center gap-10 justify-center px-4 ">
