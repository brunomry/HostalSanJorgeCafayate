...
const Nosotros = () => {
  return (
    <>
      ...
      <section className="w-[100%] relative p-20 flex flex-col items-center gap-10 justify-center">
        <article className="md:w-[70%] flex flex-col gap-5  ">
          <div>
            <h1 className="text-start text-[45px]">Sobre Nosotros</h1>
          ...
          <div>
            {" "}
            <h2 className="text-[25px] mb-2">Nuestra historia</h2>
            <p className="text-gray-600">
        ...
        <article className="w-[70%] flex flex-col gap-3">
          <div className="flex flex-col gap-2">
            <h2 className="text-[25px]">Misión</h2>
            <p className="text-gray-600">
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-[25px]">Visión</h2>
            <p className="text-gray-600">
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-[25px]">Valores</h2>
