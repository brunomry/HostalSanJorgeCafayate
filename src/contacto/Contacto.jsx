...
const Contacto = () => {
  return (
    <>
      ...
      <section className="w-[100%] vsm:py-20 vsm:px-3 mb:px-5 md:px-20 md:py-20 lg:py-32 xl:py-40 flex justify-center flex-wrap vsm:gap-5 md:gap-10">
        <article className="vsm:w-[100%] xl:w-[45%] order-1 xl:order-[0]">
        ...
        <article className="vsm:mt-5 md:mt-10 vsm:w-[100%] xl:w-[45%]">
          <h2 className="mb-3 vsm:text-[20px] md:text-[25px] font-medium">Contáctanos</h2>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="border-b pb-5 md:border-0 md:pb-0">
        ...
        <article className="d-flex flex-column align-items-center mt-5 w-[100%] order-2">
          <h2 className="text-center py-3  vsm:text-[20px] md:text-[25px]">Déjanos tu consulta</h2>
