  ...
  return (
    ...
    <div className="bg-[rgba(172,171,171,0.1)] flex justify-center">
      <div id="default-carousel" class="relative w-full" data-carousel="static">
        <div class="relative h-56 overflow-hidden flex justify-center md:h-96 cursor-zoom-in" onClick={() => openCarousel(imgActual)}>
        ...
        <button
          ...
          onClick={handlePrev}
        >
          <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-500  group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
            <svg
