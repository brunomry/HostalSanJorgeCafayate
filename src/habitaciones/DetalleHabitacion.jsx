        ...
        <div className="flex flex-col flex-wrap vsm:gap-3 md:flex-row md:gap-10 vsm:w-[100%]">
          ...
          <article className="vsm:w-[100%] lg:w-[45%] md:mt-28 lg:mt-0">
            <div className="flex flex-col vsm:gap-2">
              <h1 className="vsm:text-[24px] mb-0 font-semibold ">{habitacion.nombre}</h1>
              <p className="text-[30px]">$ {habitacion.precio}</p>
              <p className="text-gray-600">{habitacion.descripcion_breve}.</p>
              <p className="text-gray-600">
                <span className="">Capacidad máxima para{" "}
                {habitacion.capacidad} {habitacion.capacidad > 1 ? "personas" : "persona"}.</span>
              </p>
              <div>
          ...
          <article className="vsm:w-[100%] lg:w-[50%] flex flex-col gap-2">
            ...
            <p className="text-gray-600">
              Además de efectivo, aceptamos transferencias bancarias y también puedes
              abonar a través de link de mercadopago proporcionado por nosotros donde podrás utilizar tu tarjeta de
