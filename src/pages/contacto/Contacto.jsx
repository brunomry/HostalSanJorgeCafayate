    ...
    <>
      ...
      <main className="w-[100%] vsm:py-20 vsm:px-3 mb:px-5 md:px-20 md:py-20 lg:py-32 xl:py-40 flex justify-center flex-wrap vsm:gap-5 md:gap-10">
        <section className="vsm:w-[100%] xl:w-[45%] order-1 xl:order-[0]">
          <p className=" my-3 text-gray-600 3xl:text-[1.2rem]">{traduccion.paginaContacto.descripcion2}</p>
          <iframe
        ...
        <section className="vsm:mt-5 md:mt-10 vsm:w-[100%] xl:w-[45%]">
          <h1 className="mb-3 text-[32px] md:text-[35px] lg:text-[45px] font-bold text-[#094067]">
            {traduccion.paginaContacto.title}
          </h1>
          <p className="mb-3 text-gray-600 3xl:text-[1.2rem]">
          {traduccion.paginaContacto.descripcion1}
          </p>
          <div className="flex flex-col gap-5 3xl:text-[1.2rem]">
            ...
            <div className="border-b border-gray-200 pb-5" title="WhatsApp: +54 387 6843082">
            ...
            <div className="border-b border-gray-200 pb-5" title="Teléfono fijo: +54 3868 422388">
        ...
        <section className="d-flex flex-column align-items-center mt-5 w-[100%] order-2">
          <h3 className="text-center py-3  vsm:text-[20px] md:text-[25px] text-[#094067]">
