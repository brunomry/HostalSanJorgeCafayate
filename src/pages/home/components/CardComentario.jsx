...
function CardComentario({ comentario, index }) {
  ...
  return (
    <div
      ...
      className={`cursor-grab ${index===3 ? "md:hidden 3xl:flex": "3xl:flex"} p-3 shadow-md md:p-5 mb-4 text-justify card  bg-slate-50 border min-w-[250px] lg:w-[280px] xl:w-[400px] flex flex-col justify-between items-center gap-3 xl:min-h-[100px] rounded-[8px] xl:p-10 hover:border-[#c5c5c5]`}
