...
function Home({traduccion}) {
  ...
  return (
    <main>
      ...
      <section className="px-4 py-24 w-[100%] xl:px-10 flex flex-col gap-5 md:gap-10  xl:py-32 bg-[#fffffe]">
        <h2 className="text-[25px] lg:text-[35px] font-bold md:text-center text-[#094067]">{traduccion.paginaFaqs.title}</h2>
        <p className="mb-3 text-gray-600 md:text-center 3xl:text-[1.2rem]">
        ...
        <div className="w-[100%] flex justify-center items-center">
          <Link
            ...
            className="bg-[#3da9fc] lg:hover:bg-[#3da9fcd2] flex justify-center items-center gap-3 px-15 p-3 md:p-4 xl:p-5 lg:px-8 xl:w-[15%] 2xl:w-[15%] 3xl:w-[10%] xl:text-[16px]"
